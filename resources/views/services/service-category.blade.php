...
@section('pageTitle', 'Services Category')
@section('content')
    ...
    <div class="row">
        <div class="col-lg-4 grid-margin ">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{route('add.service.category')}}" method="POST">
                        @csrf
                        <div class="mb-3">
        ...
        <div class="modal fade" id="sliderModal{{$item->id}}" tabindex="-1" aria-labelledby="serviceCatModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <h5 class="modal-title" id="sliderModalLabel">Edit Service Category </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="btn-close"></button>
                </div>
                <div class="modal-body ">
                <form class="forms-sample" action="{{route('update.service.category', ['id' => $item->id])}}" method="POST" enctype="multipart/form-data">
                    @csrf
